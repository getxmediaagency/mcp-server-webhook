"""
Main Entry Point for Modular MCP Server (Render Optimized)

This script starts the MCP server optimized for Render deployment.
"""
...
async def main():
    """Main server startup function optimized for Render."""
    try:
        ...
        # Start the server using aiohttp runner (Render compatible)
        logger.info(f"Server starting on {host}:{port}")
        
        # Use aiohttp runner for better Render compatibility
